...
namespace MyCart.Core.Services
{
    public class LocalDataStore : IDataStore
    {
        ...
        public bool AddItem(string pid)
        {
        ...
        Task<bool> IDataStore.AddItem(string pid)
        {
            throw new NotImplementedException();
        }

        Task<bool> IDataStore.RemoveProduct(string pid)
        {
            throw new NotImplementedException();
        }

        Task<bool> IDataStore.ClearProducts()
        {
            throw new NotImplementedException();
        }

        Task<IEnumerable<string>> IDataStore.GetItems()
        {
            throw new NotImplementedException();
        }

        Task<bool> IDataStore.ValidateUser(string email, string password)
        {
            throw new NotImplementedException();
        }
    }
